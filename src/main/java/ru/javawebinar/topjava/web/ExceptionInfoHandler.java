...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo validationError(HttpServletRequest req, Exception e) {
        ...
        {
            list = ValidationUtil.getErrorResponse(((BindException) e).getFieldErrors());
        }
        else
        {
            list = ValidationUtil.getErrorResponse(((MethodArgumentNotValidException) e).getBindingResult().getFieldErrors());
        }
        String[] errors = list.toArray(new String[0]);
