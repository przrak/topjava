...
public class MealTestData {
    ...
    public static final Meal USER_MEAL_1 = new Meal(USER_MEAL_ID_1, LocalDateTime.of(2019, Month.FEBRUARY, 25, 23, 5), "Завтрак", 500);
    public static final Meal USER_MEAL_2 = new Meal(USER_MEAL_ID_2, LocalDateTime.of(2019, Month.FEBRUARY, 26, 19, 13), "Обед", 600);
